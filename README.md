...
<p align="center">
    A hand-picked collection of the best C# resources, tutorials, libraries, tools, and frameworks to help you level-up your development game.
</p>

<p align="center">
  <a href="#documentation">📖 Documentation</a> •
  <a href="#ide">💻 IDEs</a> •
  <a href="#learn">📚 Learning Resources</a> •
  <a href="#cheatsheets">🗒️ Cheatsheets</a> •
  <a href="#blogs">✍️ Blogs</a> •
  <a href="#platforms">🌐 Platforms</a> •
  <a href="#libraries">📦 Libraries & Tools</a>
</p>
...
- [Clean Architecture with .NET Core & React+Redux](https://github.com/ivanpaulovich/clean-architecture-manga) - Sample implementation of the Clean Architecture Principles with .NET Core. Use cases as a central organizing structure, decoupled from frameworks and technology details. Built by small components that are developed and tested in isolation.
...
- [Know Your Toolset](https://knowyourtoolset.com/) - A blog centred around ASP.NET and development tools such as Docker by Pluralsight Author Erik Dahl.
...
- [Workflow Core](https://github.com/danielgerlag/workflow-core) - A lightweight embeddable workflow engine.
...
- [Fluent Assertions](https://github.com/fluentassertions/fluentassertions) - an extensive set of extension methods that allow you to more naturally specify the expected outcome of a TDD or BDD-style unit test.
...
- [DotNetty](https://github.com/Azure/DotNetty) - A port of Netty, an asynchronous event-driven network application framework for rapid development of maintainable high-performance protocol servers & clients.
...
- [DotnetSpider](https://github.com/dotnetcore/DotnetSpider) - a .NET standard web crawling library. It is a lightweight, efficient and fast high-level web crawling & scraping framework.
...
- [Math.NET Numerics](https://github.com/mathnet/mathnet-numerics) - An open-source numerical library for .Net, Silverlight and Mono.
...
- [Cake](https://github.com/cake-build/cake) - Cake (C# Make) is a build automation system with a C# DSL to do things like compiling code, copying files/folders, running unit tests, compressing files and building NuGet packages.
